...
export class MyserviceService {
  ...
  getforcast(params): Observable<any> {
    ...
    return this.http.get('http://api.weatherapi.com/v1/forecast.json', {
      params: params,
      headers: header,
    });
  }
  ...
  getCurrencylist(): Observable<any> {
    var myHeaders = {
      apikey: '9Fiq7gTTac8ykyWVTFtuQU7G3RXf3cHb',
    };
    let params = {
    ...
    return this.http.get('https://api.apilayer.com/currency_data/timeframe', {
      params: params,
      headers: myHeaders,
    });
  }
